...
class TPStatsBlocklistsTests: XCTestCase {
    ...
    func testURLInListPerformance() {
        ...
        self.measureMetrics([.wallClockTime], automaticallyStartMeasuring: true) {
            for _ in 0..<100 {
                _ = blocklists.urlIsInList(URL(string: "https://www.decentr.com")!, mainDocumentURL: URL(string: "http://foo.com")!, safelistedDomains: safelistedRegexs)
            }
            self.stopMeasuring()
        }
    }
    ...
    func testURLInList() {
        ...
        XCTAssertEqual(blocklist("https://www.decentr.com"), nil)
