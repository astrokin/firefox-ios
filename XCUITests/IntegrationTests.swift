...
class IntegrationTests: BaseTestCase {
    ...
    func testFxASyncPageUsingChinaFxA () {
        ...
        waitForNoExistence(app.webViews.otherElements.staticTexts["Decentr Monitor"])
        XCTAssertFalse(app.webViews.otherElements.staticTexts["Decentr Monitor"].exists)
    }
