    ...
    fileprivate func processRequest(request: DataRequest, _ managerId: String, _ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) {
        ...
        case is String.Type:
            validatedRequest.responseString(completionHandler: { (stringResponse) in
                ...
                if stringResponse.isFail() {
                    completion(
                        nil,
                        ErrorResponse.error(stringResponse.response?.statusCode ?? 500, stringResponse.data, stringResponse.getError()!)
                    )
                    return
                }
                ...
                completion(
                    Response(
                        ...
                        body: ((stringResponse.getValue()) as! T)
                    ),
                    nil
                )
            })
        case is URL.Type:
            validatedRequest.responseData(completionHandler: { (dataResponse) in
                ...
                do {
                    ...
                    guard !dataResponse.isFail() else {
        ...
        case is Void.Type:
            validatedRequest.responseData(completionHandler: { (voidResponse) in
                ...
                if voidResponse.isFail() {
                    completion(
                        nil,
                        ErrorResponse.error(voidResponse.response?.statusCode ?? 500, voidResponse.data, voidResponse.getError()!)
                    )
                    return
                }
        ...
        default:
            validatedRequest.responseData(completionHandler: { (dataResponse) in
                ...
                if dataResponse.isFail() {
                    completion(
                        nil,
                        ErrorResponse.error(dataResponse.response?.statusCode ?? 500, dataResponse.data, dataResponse.getError()!)
                    )
                    return
                }
    ...
    override fileprivate func processRequest(request: DataRequest, _ managerId: String, _ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) {
        ...
        default:
            validatedRequest.responseData(completionHandler: { (dataResponse: DataResponse<Data, AFError>) in
                ...
                guard !dataResponse.isFail() else {
                    completion(nil, ErrorResponse.error(dataResponse.response?.statusCode ?? 500, dataResponse.data, dataResponse.getError()!))
                    return
                }
...
public extension DataResponse where Success == String {
