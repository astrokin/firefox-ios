...
private let browsingActivityType: String = "org.mozilla.ios.decentr.browsing"
...
extension UserActivityHandler {
    func spotlightIndex(_ page: ReadabilityResult, for tab: Tab) {
        ...
        let item = CSSearchableItem(uniqueIdentifier: identifier, domainIdentifier: "org.mozilla.ios.decentr", attributeSet: attributeSet)
